        ...
        <Row>
            ...
            <Card>
              <Card.Header>
                <Button
                  ...
                  onClick={() => this.setState({ isBasic: !isBasic })}
          ...
          <Col sm={12}>
            ...
            <Button
              ...
              aria-expanded={isMultiTarget.some(
            ...
            <Button onClick={this.multiTargetHandler}>
            ...
            <Row>
              <Col>
                <Card className="mt-2">
                  <Collapse
                    in={isMultiTarget.some((target) => target === "target1")}
                  >
                    <div id="target1">
              ...
              <Col>
                <Card className="mt-2">
                  <Collapse
                    in={isMultiTarget.some((target) => target === "target2")}
                  >
                    <div id="target2">
